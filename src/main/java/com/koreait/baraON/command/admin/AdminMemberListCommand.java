...
public class AdminMemberListCommand implements AdminMemberCommand {
	...
	public Map<String, Object> execute(SqlSession sqlSession, Model model) {
		...
		int totalRecord = adminMemberDao.memberCount();
		...
		List<AdminMemberDto> list = adminMemberDao.adminMemberList(beginRecord, endRecord);
