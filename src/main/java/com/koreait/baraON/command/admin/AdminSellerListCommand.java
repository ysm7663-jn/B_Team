...
public class AdminSellerListCommand implements AdminMemberCommand {
	...
	public Map<String, Object> execute(SqlSession sqlSession, Model model) {
		...
		int totalRecord = adminSellerDao.sellerCount();
		...
		List<AdminSellerDto> list = adminSellerDao.adminSellerList(beginRecord, endRecord);
