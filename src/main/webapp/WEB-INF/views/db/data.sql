...
(
    ...
    M_NICK         VARCHAR2(100)    DEFAULT 'M_ID' NOT NULL, 
    M_EMAIL        VARCHAR2(100)    NOT NULL, 
    M_REGDATE      DATE             DEFAULT SYSDATE NOT NULL, 
    M_AUTH         CHAR(1)          DEFAULT '0' NOT NULL, 
...
(
    ...
    C_PART       INT               DEFAULT 0'단기' 1'장기' NOT NULL, 
...
CREATE OR REPLACE TRIGGER CLUB_AI_TRG
...
CREATE OR REPLACE TRIGGER PLACECATEGORY_AI_TRG
BEFORE INSERT ON PLACECATEGORY 
REFERENCING NEW AS NEW FOR EACH ROW 
BEGIN 
    SELECT PLACECATEGORY_SEQ.NEXTVAL
    INTO :NEW.PC_NO
    FROM DUAL;
END;
/

--DROP TRIGGER PLACECATEGORY_AI_TRG;
/
...
CREATE OR REPLACE TRIGGER SELLER_AI_TRG
...
CREATE OR REPLACE TRIGGER PLACE_AI_TRG
...
CREATE OR REPLACE TRIGGER PLACE_OPTION_AI_TRG
BEFORE INSERT ON PLACE_OPTION 
REFERENCING NEW AS NEW FOR EACH ROW 
BEGIN 
    SELECT PLACE_OPTION_SEQ.NEXTVAL
    INTO :NEW.PO_NO
    FROM DUAL;
END;
/

--DROP TRIGGER PLACE_OPTION_AI_TRG;
/
...
COMMENT ON COLUMN PLACE_OPTION.PO_PRICE IS '가격'
/
...
CREATE OR REPLACE TRIGGER CLUBLIST_AI_TRG
BEFORE INSERT ON CLUBLIST 
REFERENCING NEW AS NEW FOR EACH ROW 
BEGIN 
    SELECT CLUBLIST_SEQ.NEXTVAL
    INTO :NEW.CL_NO
    FROM DUAL;
END;
/

--DROP TRIGGER CLUBLIST_AI_TRG;
/
...
CREATE OR REPLACE TRIGGER REPLY(BOARD)_AI_TRG
BEFORE INSERT ON REPLY(BOARD) 
REFERENCING NEW AS NEW FOR EACH ROW 
BEGIN 
    SELECT REPLY(BOARD)_SEQ.NEXTVAL
    INTO :NEW.R_NO
    FROM DUAL;
END;
/

--DROP TRIGGER REPLY(BOARD)_AI_TRG;
/
...
CREATE OR REPLACE TRIGGER RESERVATION(OR BOOKING)_AI_TRG
BEFORE INSERT ON RESERVATION(OR BOOKING) 
REFERENCING NEW AS NEW FOR EACH ROW 
BEGIN 
    SELECT RESERVATION(OR BOOKING)_SEQ.NEXTVAL
    INTO :NEW.RES_NO
    FROM DUAL;
END;
/

--DROP TRIGGER RESERVATION(OR BOOKING)_AI_TRG;
/
