		...
		<div class="insert-wrap">
			...
			<div class="inputs">
				<div class="title">클럽명</div>
					<input type="text" name="c_title" id="input" placeholder="  제목을 입력해주세요" required /><br/><br/>
					
				<div class="title">한 줄 설명</div>
					<input type="text" name="c_desc" id="input" placeholder="  한 줄 설명을 입력해주세요" required /><br/><br/>
					
				<div class="title">최소인원</div>
					<input type="text" name="c_min" id="input" placeholder="  최소인원을 입력해주세요" required/><br/><br/>
					
				<div class="title">최대인원</div>
					<input type="text" name="c_max" id="input" placeholder="  최대인원을 입력해주세요" required/><br/><br/>
					
				<div class="title">활동시작날짜</div>
					<input type="text" name="c_startDate" id="input" placeholder="  ex) 20xx.xx.xx" required/><br/><br/>
					
				<div class="title">활동종료날짜</div>
					<input type="text" name="c_endDate" id="input" placeholder="  ex) 20xx.xx.xx" required/><br/><br/>
					
				<div class="title">클럽내용</div>
					<textarea rows="20" cols="100" id="c_content" name="c_content" placeholder=" 2000자 이내로 작성해주세요" required></textarea>
				<br/><br/>
			</div>
		</div>
		<%-- hidden --%>
